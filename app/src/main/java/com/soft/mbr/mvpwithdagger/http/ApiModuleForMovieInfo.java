...
@Module
public class ApiModuleForMovieInfo {

    public final String BASE_URL = "http://www.omdbapi.com";
    public final String API_KEY = "6dedf5f3";
    ...
    @Provides
    public MovieInfoApiService provideApiService(){
        return  provideRetrofit(BASE_URL, provideClient()).create(MovieInfoApiService.class);
    }
}
